...
<title>Insert title here</title>
    ...
    <meta name="description" content="Welcome to our cutting-edge Expense Tracker website, your ultimate companion in financial management! Our platform is designed to empower you with efficient tools to track your expenses, plan your budget, and achieve your financial goals seamlessly.">
    ...
    <!-- Social media share -->
    <meta property="og:title" content="Expense-Tastic - your everyday expense tracker">
    <meta property="og:site_name" content="Themesberg">
    <meta property="og:url" content="https://https://demo.themesberg.com/landwind/">
    <meta property="og:description" content="Welcome to our cutting-edge Expense Tracker website, your ultimate companion in financial management! Our platform is designed to empower you with efficient tools to track your expenses, plan your budget, and achieve your financial goals seamlessly. ">
            ...
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="--" class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        <path id="path0_fill" class="st0" d="M50 300c27.6 0 50-22.4 50-50v-50H50c-27.6 0-50 22.4-50 50s22.4 50 50 50z"/><path id="path1_fill" class="st1" d="M0 150c0-27.6 22.4-50 50-50h50v100H50c-27.6 0-50-22.4-50-50z"/><path id="path1_fill_1_" class="st2" d="M0 50C0 22.4 22.4 0 50 0h50v100H50C22.4 100 0 77.6 0 50z"/><path id="path2_fill" class="st3" d="M100 0h50c27.6 0 50 22.4 50 50s-22.4 50-50 50h-50V0z"/><path id="path3_fill" class="st4" d="M200 150c0 27.6-22.4 50-50 50s-50-22.4-50-50 22.4-50 50-50 50 22.4 50 50z"/></svg> SIGN UP
                    </a>
                </div>
            </div>
